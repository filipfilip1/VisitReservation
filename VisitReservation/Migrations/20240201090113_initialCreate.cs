    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatedDiseases", x => x.TreatedDiseaseId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoctorAppointmentSlotId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorAppointmentSlots", x => x.DoctorAppointmentSlotId);
                    table.ForeignKey(
                        name: "FK_DoctorAppointmentSlots_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorAppointmentSlots_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorEducations", x => new { x.DoctorId, x.EducationId });
                    table.ForeignKey(
                        name: "FK_DoctorEducations_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorMedicalServices", x => new { x.DoctorId, x.MedicalServiceId });
                    table.ForeignKey(
                        name: "FK_DoctorMedicalServices_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorSpecializations_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorTreatedDiseases", x => new { x.DoctorId, x.TreatedDiseaseId });
                    table.ForeignKey(
                        name: "FK_DoctorTreatedDiseases_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "TreatedDiseaseId",
                        onDelete: ReferentialAction.Cascade);
                });
